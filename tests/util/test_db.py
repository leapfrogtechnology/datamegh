...
def test_build_connstr_3():
    ...
    assert connstr_mysql == 'DRIVER={MySQL ODBC 8.0 Driver};SERVER=localhost;PORT=3306;DATABASE=test;UID=test;PWD=Test@123'
...
def test_build_connstr_4():
    ...
    assert connstr_mysql == 'DRIVER=SOME_OTHER_DRIVER;SERVER=localhost;PORT=33066;DATABASE=test;UID=test;PWD=Test@123'
